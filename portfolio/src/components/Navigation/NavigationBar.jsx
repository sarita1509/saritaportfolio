...
const NavigationBar = () => {
  return (
    ...
    <a class="navbar-brand" href="#">
      <img src="https://img.freepik.com/free-vector/colorful-letter-s-with-black-background_483537-4543.jpg?t=st=1717518354~exp=1717521954~hmac=86d56b2d1e97eb3298d5d1cfb0a168d22943f20e59d52fb619ef9487f85b0aea&w=740" height="20" alt="S Logo"
        loading="lazy" />
    </a>
  </div>
        </Navbar.Brand>
